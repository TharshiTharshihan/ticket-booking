    ...
    <div className="p-6 bg-gray-50 min-h-screen">
          ...
          {filteredTickets.map((ticket) => (
            ...
            >
              ...
              <div className="flex justify-between items-start">
                ...
                <span
                  className={`text-xs px-3 py-1 rounded-full font-medium ${statusColor[ticket.status]}`}
                >
                  {ticket.status}
                </span>
      ...
      {selectedTicket && (
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          ...
          <div className="bg-white rounded-3xl w-[90%] md:w-[600px] p-6 relative">
            ...
            <div className="mt-4 flex gap-3">
              ...
              <span
                className={`px-3 py-1 rounded-full text-xs ${statusColor[selectedTicket.status]}`}
              >
